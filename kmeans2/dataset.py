...
class Dataset:
    ...
    def set_mappings(self):
        self.genre_to_id = {val: i for i, val in enumerate(self.GENRES)}
        self.id_to_genre = {i: val for i, val in enumerate(self.GENRES)}
        ...
        for user in tqdm(ratings_by_user, desc="get matrix"):
            ...
            for m_id, rating in ratings_by_user[user]:
                if m_id in movies_map:
                    ...
                    count += 1
            user_vector = [i / count for i in user_vector]
